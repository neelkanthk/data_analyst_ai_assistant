...
def generate_sql_from_user_query(user_query: str) -> str:
    ...
    prompt = f"""
            You are an SQL expert. Convert the user's question into a valid PostgreSQL query. The response should only contain the SQL query without any explanations.
            Database schema:
            {db_schema}
